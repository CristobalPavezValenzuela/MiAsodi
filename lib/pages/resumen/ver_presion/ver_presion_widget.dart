...
import 'ver_presion_model.dart';
export 'ver_presion_model.dart';

class VerPresionWidget extends StatefulWidget {
  const VerPresionWidget({super.key});

  @override
  _VerPresionWidgetState createState() => _VerPresionWidgetState();
}

class _VerPresionWidgetState extends State<VerPresionWidget> {
  late VerPresionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerPresionModel());
  }
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, listViewIndex) {
                            final listViewRegistroPresionRecord =
                                listViewRegistroPresionRecordList[
                                    listViewIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 12.0),
