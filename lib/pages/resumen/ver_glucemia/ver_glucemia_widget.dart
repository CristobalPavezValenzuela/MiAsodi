...
import 'ver_glucemia_model.dart';
export 'ver_glucemia_model.dart';

class VerGlucemiaWidget extends StatefulWidget {
  const VerGlucemiaWidget({super.key});

  @override
  _VerGlucemiaWidgetState createState() => _VerGlucemiaWidgetState();
}

class _VerGlucemiaWidgetState extends State<VerGlucemiaWidget> {
  late VerGlucemiaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerGlucemiaModel());
  }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              10.0, 10.0, 10.0, 20.0),
                          child: StreamBuilder<List<RegistroGlucemiaRecord>>(
                      ...
                      stream: queryRegistroGlucemiaRecord(
                        queryBuilder: (registroGlucemiaRecord) =>
                            registroGlucemiaRecord
                                ...
                                .orderBy('registro_glucemia', descending: true),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                        ...
                        List<RegistroGlucemiaRecord>
                            listViewRegistroGlucemiaRecordList = snapshot.data!;
                        if (listViewRegistroGlucemiaRecordList.isEmpty) {
                          return const Center(
                        ...
                        return ListView.builder(
                          ...
                          itemCount: listViewRegistroGlucemiaRecordList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewRegistroGlucemiaRecord =
                                listViewRegistroGlucemiaRecordList[
                                    listViewIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 12.0),
                                    ...
                                    children: [
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    4.0, 0.0, 0.0, 0.0),
                                            child: Text(
                                              'Glucemia: ${listViewRegistroGlucemiaRecord.registroGlucemia.toString()}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .headlineSmall,
                                            ),
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Text(
                                            'Nivel de glucemia: ${() {
                                              if (listViewRegistroGlucemiaRecord
                                                      .registroGlucemia <
                                                  100.0) {
                                                return 'Bajo';
                                              } else if (listViewRegistroGlucemiaRecord
                                                      .registroGlucemia >
                                                  125.0) {
                                                return 'Alto';
                                              } else {
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      dateTimeFormat(
                                                        'MMMEd',
                                                        listViewRegistroGlucemiaRecord
                                                            .fechaRegistro!,
                                                        locale:
                                                            FFLocalizations.of(
                                                                    context)
