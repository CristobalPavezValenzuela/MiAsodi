...
import '/components/registrar_glucemia_componente/registrar_glucemia_componente_widget.dart';
...
class RegistrarGlucemiaWidget extends StatefulWidget {
  const RegistrarGlucemiaWidget({super.key});
              ...
              builder: (context) {
                return GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: const RegistrarGlucemiaComponenteWidget(),
                  ),
                );
              },
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          final listViewRegistroGlucemiaRecord =
                              listViewRegistroGlucemiaRecordList[listViewIndex];
                          return Padding(
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            ...
                                            if (confirmDialogResponse) {
                                              await listViewRegistroGlucemiaRecord
                                                  .reference
                                                  .delete();
                                              return;
                                            } else {
