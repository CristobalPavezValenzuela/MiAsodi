...
import 'editar_f_icha_personal_model.dart';
export 'editar_f_icha_personal_model.dart';

class EditarFIchaPersonalWidget extends StatefulWidget {
  const EditarFIchaPersonalWidget({super.key});

  @override
  _EditarFIchaPersonalWidgetState createState() =>
      _EditarFIchaPersonalWidgetState();
}

class _EditarFIchaPersonalWidgetState extends State<EditarFIchaPersonalWidget>
    with TickerProviderStateMixin {
  late EditarFIchaPersonalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarFIchaPersonalModel());
    ...
    _model.apellidoPaternoController ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.apellidoPaterno, ''),
      'No info',
    ));
    _model.apellidoPaternoFocusNode ??= FocusNode();

    _model.apellidoMaternoController ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.apellidoMaterno, ''),
      'No info',
    ));
    _model.apellidoMaternoFocusNode ??= FocusNode();

    _model.rutController ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.rut, ''),
      'No info',
    ));
    ...
    _model.estaturaController ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.estatura, 0.0).toString(),
      'No info',
    ));
    ...
    _model.hospitalPertenecienteController1 ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.hospitalPerteneciente, ''),
      'No info',
    ));
    _model.hospitalPertenecienteFocusNode1 ??= FocusNode();

    _model.hospitalPertenecienteController2 ??= TextEditingController(
        text: valueOrDefault<String>(
      valueOrDefault(currentUserDocument?.alergias, ''),
      'No info',
    ));
    _model.hospitalPertenecienteFocusNode2 ??= FocusNode();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => TextFormField(
                          controller: _model.apellidoPaternoController,
                          focusNode: _model.apellidoPaternoFocusNode,
                          obscureText: false,
                          decoration: InputDecoration(
                          ...
                          validator: _model.apellidoPaternoControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => TextFormField(
                          controller: _model.apellidoMaternoController,
                          focusNode: _model.apellidoMaternoFocusNode,
                          obscureText: false,
                          decoration: InputDecoration(
                          ...
                          validator: _model.apellidoMaternoControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => TextFormField(
                          controller: _model.hospitalPertenecienteController1,
                          focusNode: _model.hospitalPertenecienteFocusNode1,
                          obscureText: false,
                          decoration: InputDecoration(
                    ...
                    Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => TextFormField(
                          controller: _model.hospitalPertenecienteController2,
                          focusNode: _model.hospitalPertenecienteFocusNode2,
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Alergicas',
                            labelStyle: FlutterFlowTheme.of(context)
                              ...
                              onPressed: () async {
                                await currentUserReference!
                                  ...
                                  hospitalPerteneciente: _model
                                      .hospitalPertenecienteController1.text,
                                  ...
                                  alergias: _model
                                      .hospitalPertenecienteController2.text,
                                  rut: _model.rutController.text,
                                  nombres: _model.nombresController.text,
                                  apellidoPaterno:
                                      _model.apellidoPaternoController.text,
                                  apellidoMaterno:
                                      _model.apellidoMaternoController.text,
                                ...
                                context.pushNamed('FichaPersonal');
                              },
                              text: 'Registrar',
                              options: FFButtonOptions(
                                width: 170.0,
