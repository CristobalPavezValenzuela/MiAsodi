...
Future<List<dynamic>> descargarAndroidReporteSintoma(
  List<RegistroSintomasRecord>? docs,
) async {
  docs = docs ?? [];
  ...
  String fileContent = header +
      "Fecha Registro         ,         Descripcion           ,          Tipo de Sintoma";
  ...
  docs.asMap().forEach((index, record) => fileContent = fileContent +
      ...
      "," +
      record.tipoSintoma.toString());

  final fileName = "Reporte de Sintomas " + DateTime.now().toString() + ".csv";
